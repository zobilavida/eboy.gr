...
class eboywp_Facet_Hierarchy extends eboywp_Facet
{
    ...
    function load_values( $params ) {
        ...
        if ( ! empty( $selected_values[0] ) ) {
            ...
            $output[] = array(
                'facet_value'           => '',
                'facet_display_value'   => __( 'Any', 'EWP' ),
                'depth'                 => 0,
                'counter'               => 1,
            );
    ...
    function render( $params ) {
        ...
        if ( ! empty( $values ) ) {
            foreach ( $values as $data ) {
                ...
                $output .= '<div class="eboywp-link' . $class . '" data-value="' . esc_attr( $data['facet_value'] ) . '">' . $label . '</div>';
