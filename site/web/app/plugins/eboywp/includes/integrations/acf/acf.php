...
class eboywp_Integration_ACF
{
    ...
    /**
     * Hijack the "eboywp_indexer_query_args" hook to lookup the fields once
     */
    ...
    function get_acf_fields_v4() {
        ...
        $class = new eboywp_acf_field_group();
