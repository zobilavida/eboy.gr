...
<thead><tr>
<th style='/*background-color:#000;*/ vertical-align:middle; font-family:inherit; font-size:12px;'>$addRegion<input class='button-primary' type='button' value='".__("Delete", SSF_WP_TEXT_DOMAIN)."' onclick=\"if(confirm('".__("Are you sure you want to remove the region[s)", SSF_WP_TEXT_DOMAIN)."?')){LF=document.forms['locationForm'];LF.act.value='delete';LF.submit();}else{return false;}\"></th>
";
