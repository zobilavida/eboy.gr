...
class FacetWP_Facet_Iconboxes extends FacetWP_Facet
{

    function __construct() {
        $this->label = __( 'Iconboxes', 'fwp' );
    }
...
<script>
(function($) {
    wp.hooks.addAction('facetwp/load/iconboxes', function($this, obj) {
    ...
    wp.hooks.addFilter('facetwp/save/iconboxes', function(obj, $this) {
    ...
    wp.hooks.addAction('facetwp/change/iconboxes', function($this) {
