...
namespace Roots\telesphorus\Wrapper;

/**
 * Theme wrapper
 *
 * @link https://roots.io/telesphorus/docs/theme-wrapper/
...
class SageWrapping {
  ...
  public function __toString() {
    $this->templates = apply_filters('telesphorus/wrap_' . $this->slug, $this->templates);
