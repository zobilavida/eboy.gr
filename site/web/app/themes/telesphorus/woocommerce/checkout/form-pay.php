	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'telesphorus' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'telesphorus' ); ?></th>
			</tr>
		</thead>
		<tbody>
