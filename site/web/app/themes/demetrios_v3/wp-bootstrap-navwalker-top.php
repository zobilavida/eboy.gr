...
/**
 * Class Name: WP_Bootstrap_Navwalker_top
...
if ( !class_exists( 'WP_Bootstrap_Navwalker_top' ) ) {

  /**
   * WP_Bootstrap_Navwalker_top class
   *
   * @package        Template
   ...
   * @author         Javier Prieto
   */
  class WP_Bootstrap_Navwalker_top extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
      ...
      $this->dropdown = true;
      $output         .= $n . str_repeat( $t, $depth ) . '<div class="dropdown-menu col-12 text-left" role="menu">' . $n;
    }
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      $classes[] = 'nav-item menu-left text-left px-4';
      ...
      if ( 0 < $depth ) {
        ...
        $item_classes[] = 'dropdown-item py-2 pr-4';
      }
