...
<form role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
	<label class="screen-reader-text" for="woocommerce-product-search-field"><?php _e( 'Search for:', 'crispshop' ); ?></label>
	...
	<button type="submit" title="Search" class="action search">
		<span><?php echo esc_attr_x( 'Search', 'submit button', 'crispshop' ); ?></span>
	</button>
