...
<div class="wc-bookings-booking-cost text-center"  ></div>
 	...
 	<button type="submit" class="wc-bookings-booking-form-button single_add_to_cart_button btn btn-primary alt disabled" data-product_id="<?php echo esc_attr( is_callable( array( $product, 'get_id' ) ) ? $product->get_id() : $product->id ); ?>"><?php echo $product->single_add_to_cart_text(); ?></button>
	</div>
