...
class FacetWP_Display
{
    ...
    function shortcode( $atts ) {
        ...
        if ( isset( $atts['facet'] ) ) {
            ...
            if ( $facet ) {
                $output = '<div class="ginput_container ginput_container_select facetwp-facet facetwp-facet-' . $facet['name'] . ' facetwp-type-' . $facet['type'] . '" data-name="' . $facet['name'] . '" data-type="' . $facet['type'] . '"></div>';
