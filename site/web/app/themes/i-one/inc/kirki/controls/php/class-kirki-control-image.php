...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'i-one' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'i-one' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'i-one' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'i-one' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'i-one' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'i-one' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'i-one' ); ?>',
		} );
		#>
		<label>
