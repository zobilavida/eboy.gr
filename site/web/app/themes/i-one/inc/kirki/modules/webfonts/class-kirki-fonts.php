...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'i-one' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'i-one' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'i-one' ),
			'200'       => esc_attr__( 'Light 200', 'i-one' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'i-one' ),
			'300'       => esc_attr__( 'Book 300', 'i-one' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'i-one' ),
			'400'       => esc_attr__( 'Normal 400', 'i-one' ),
			'regular'   => esc_attr__( 'Normal 400', 'i-one' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'i-one' ),
			'500'       => esc_attr__( 'Medium 500', 'i-one' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'i-one' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'i-one' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'i-one' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'i-one' ),
			'700'       => esc_attr__( 'Bold 700', 'i-one' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'i-one' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'i-one' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'i-one' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'i-one' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'i-one' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'i-one' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'i-one' ),
		);
	}
