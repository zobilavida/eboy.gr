...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'i-one' ),
				'change'       => esc_attr__( 'Change image', 'i-one' ),
				'default'      => esc_attr__( 'Default', 'i-one' ),
				'remove'       => esc_attr__( 'Remove', 'i-one' ),
				'placeholder'  => esc_attr__( 'No image selected', 'i-one' ),
				'frame_title'  => esc_attr__( 'Select image', 'i-one' ),
				'frame_button' => esc_attr__( 'Choose image', 'i-one' ),
			)
		);
	}
