<div class="<?php echo esc_attr($atts['before_item_class']); ?>">
	<div class="wiloke-listgo-listing-item listing listing--list2 <?php echo esc_attr($termClasses); ?>" data-postid="<?php echo esc_attr($postID); ?>" data-info="<?php echo esc_attr(json_encode($aInfo)); ?>">
