...
$aHeaderImgData = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large');
if ( empty($headerImg) ){
				...
				<div class="col-md-8">
					<div class="listing-single">
						...
						<div class="listing-single__media">
							<?php if ( !empty($aHeaderImgData) ) :?>
							<img class="lazy" data-src="<?php echo esc_url($aHeaderImgData[0]); ?>" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt="<?php the_title(); ?>" width="<?php echo esc_attr($aHeaderImgData[1]); ?>" height="<?php echo esc_attr($aHeaderImgData[2]); ?>">
							<?php endif; ?>
						</div>
